        ...
        <div className="w-full max-w-md relative">
            ...
            <div className="relative p-8 rounded-3xl bg-[#0f172a]/60 backdrop-blur-xl border border-white/10 shadow-2xl">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-slate-400 text-sm">Join us to start tracking your expenses.</p>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit} autoComplete="off">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-violet-600 to-cyan-600 text-white font-bold text-lg shadow-[0_0_20px_-5px_rgba(6,182,212,0.5)] hover:shadow-[0_0_25px_-5px_rgba(6,182,212,0.7)] hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                >
                  {loading ? (
